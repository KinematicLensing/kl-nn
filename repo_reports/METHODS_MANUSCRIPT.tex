...
\maketitle
\begin{center}
\small\textbf{Monitored-source fingerprint:} \code{de824a4303ad3ac3a4debe477e7c9804db65b5cb335a7de4b8fd845e30b53a49}
\end{center}
...
Spectrum & Conv pairs at 16, 32, 64, and 128 channels, each convolution followed by BatchNorm and ReLU; no wavelength pooling; two 256-channel convolutions; final \code{5x64} convolution spanning every fiber and all 64 wavelength bins & 512 \\
...
bins through the stack and collapses them with a final \code{5x64} kernel. It therefore models the
